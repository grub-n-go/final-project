    ...
    return (
      <div className='landing-green-background'>
        <Menu style={menuStyle} attached="top" borderless fluid widths={6} >
          ...
          <Menu.Item>
            <span className='nav-bar-bowfolio-green' style={{ fontWeight: 800, fontSize: '14px' }}>
          ...
          <Menu.Item>
            {this.props.currentUser === '' ? (
              <span style={{ fontWeight: 800, fontSize: '20px' }}>
                <Dropdown id="login-dropdown" className='nav-bar-bowfolio-green' text="Login" icon={'user'}>
                  <Dropdown.Menu>
