...
<<<<<<< HEAD
      <Menu style={menuStyle} attached="top" borderless>
        <Menu.Item as={NavLink} activeClassName="" exact to="/">
          <span className='bowfolio-green' style={{ fontWeight: 800, fontSize: '24px' }}>Grub-n-Go</span>
        </Menu.Item>
        ...
        <Menu.Item position="right">
          {this.props.currentUser === '' ? (
            <Dropdown id="login-dropdown" className='login' text="Login" pointing="top right" icon={'user'}>
              <Dropdown.Menu>
...
=======
      <Container>
        <Menu style={menuStyle} attached="top" borderless>
          ...
          {Roles.userIsInRole(Meteor.userId(), 'admin') ? (
            <Menu.Item as={NavLink} activeClassName="active" className='adminLinks' exact to="/adduser" key='adduser'>Add User</Menu.Item>
          ) : ''}
